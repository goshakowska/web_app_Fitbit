...
ALTER TABLE exercise_history_param_value ADD CONSTRAINT exercise_his_param_value_pk PRIMARY KEY ( param_value_id );
...
ALTER TABLE favourite_exercises
    ADD CONSTRAINT favourite_exercises_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( client_id );
